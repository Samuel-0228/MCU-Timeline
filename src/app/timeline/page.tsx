...
import McuIntroGate from "../../components/McuIntroGate";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      setIsIntroComplete(localStorage.getItem("mcu_intro_complete") === "true");
  ...
  const handleIntroComplete = (choice: "captain" | "ironman") => {
    if (typeof window !== "undefined") {
      localStorage.setItem("mcu_intro_complete", "true");
      localStorage.setItem("hero_choice", choice);
      localStorage.setItem("mcu_user_perspective", choice === "captain" ? "cap" : "ironman");
    }
  ...
  if (!isIntroComplete) {
    return <McuIntroGate onComplete={handleIntroComplete} />;
  }
